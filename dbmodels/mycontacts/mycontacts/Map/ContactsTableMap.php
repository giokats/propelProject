...
namespace mycontacts\mycontacts\Map;
...
class ContactsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mycontacts.mycontacts.Map.ContactsTableMap';
     ...
     */
    const OM_CLASS = '\\mycontacts\\mycontacts\\Contacts';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'mycontacts.mycontacts.Contacts';
     ...
     */
    const COL_ID = 'contacts.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'contacts.name';

    /**
     * the column name for the phone field
     */
    const COL_PHONE = 'contacts.phone';

    /**
     * the column name for the email field
     */
    const COL_EMAIL = 'contacts.email';

    /**
     * the column name for the address field
     */
    const COL_ADDRESS = 'contacts.address';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Phone', 'Email', 'Address', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'phone', 'email', 'address', ),
        self::TYPE_COLNAME       => array(ContactsTableMap::COL_ID, ContactsTableMap::COL_NAME, ContactsTableMap::COL_PHONE, ContactsTableMap::COL_EMAIL, ContactsTableMap::COL_ADDRESS, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'phone', 'email', 'address', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Phone' => 2, 'Email' => 3, 'Address' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'phone' => 2, 'email' => 3, 'address' => 4, ),
        self::TYPE_COLNAME       => array(ContactsTableMap::COL_ID => 0, ContactsTableMap::COL_NAME => 1, ContactsTableMap::COL_PHONE => 2, ContactsTableMap::COL_EMAIL => 3, ContactsTableMap::COL_ADDRESS => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'phone' => 2, 'email' => 3, 'address' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\mycontacts\\mycontacts\\Contacts');
        $this->setPackage('mycontacts.mycontacts');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ContactsTableMap::COL_ID);
            $criteria->addSelectColumn(ContactsTableMap::COL_NAME);
            $criteria->addSelectColumn(ContactsTableMap::COL_PHONE);
            $criteria->addSelectColumn(ContactsTableMap::COL_EMAIL);
            $criteria->addSelectColumn(ContactsTableMap::COL_ADDRESS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \mycontacts\mycontacts\Contacts) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ContactsTableMap::DATABASE_NAME);
            $criteria->add(ContactsTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ContactsTableMap::COL_ID) && $criteria->keyContainsValue(ContactsTableMap::COL_ID) ) {
